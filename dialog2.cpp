...
void Dialog2::on_pushButton_2_clicked()
{
    ...
    {
        a = FindHiddenButton2()->property("tag").toInt();//Tag中记录是行列位置
        i=rand()%4;
        if(0<=a+b[i]&&a+b[i]<N2*N2)
            if(IsNeighbor2(FindHiddenButton2(),buttons2[a+b[i]]))
            Swap2(FindHiddenButton2(),buttons2[a+b[i]]);
    }
}
...
void Dialog2::on_pushButton_2_clicked()
{
    ...
    {
        int a=rand()%(N2*N2);
        if(IsNeighbor2(buttons2[a],FindHiddenButton2()))
            Swap2(buttons2[a],FindHiddenButton2());
    }
}
*/
